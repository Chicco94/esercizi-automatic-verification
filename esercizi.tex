...
Una parola $x$ è un V-testimone se esistono $v \in V, u \in U (U \congAlpha$-classe) tali che $x=v\cdot u$. Inoltre  sappiamo che $m$ è minimo, quindi $u$ a sua volta dovrà essere minimo.
\begin{center}
