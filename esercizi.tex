...
Dato che $\sim$ ha indice finito, per un $m$ fisso, ci troviamo in una situazione del genere:
...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
Dove il numero di classi di equivalenza è limitato dal numero di classi di equivalenza di $\sim$.
