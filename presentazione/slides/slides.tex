...
\begin{frame}
	...
	\note{
		...
		$x+1t = (x_1,\ldots,x_n)+(1,\ldots,1)t=(x_1+t,\ldots,x_n+t)$
...
\begin{frame}
	...
	Wlog, we assume that foe every $q \in Q,\sigma in \Sigma_c$ there is at most one $r=\langle q,\sigma,g,f,q'\rangle \in R$.
